...
class Vehicle():
    def __init__(self,vehicle_type) :              #set attribute in Vehicle to have type
...
car = Automobile(input("What type of vehicle? :"),           #user input for attributes
    ...
    input( "Is the roof 'solid' or 'sun roof'? :"))
                                                            ...
                                                            #f string docu print method of print
print(f"""                                                    
