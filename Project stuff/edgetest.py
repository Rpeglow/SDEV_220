...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        #setting central widget to main window
...
#--------------------------------------GuiUserName QLineEdit----------------------------------------------------------#
        ...
        self.GuiUserName.setStyleSheet("background-color:rgba(0,0,0,0);\n"
                                        ...
                                        "color:rgba(9,9,9,1);\n"
                                        "padding-bottom:7px;")
        self.GuiUserName.setObjectName("UserName")
        ###Get user input from QLineEdit


#--------------------------------------GuiUserPassword QLineEdit----------------------------------------------------------#
...
#--------------------------------------Login Button----------------------------------------------------------#
        ...
        #self.Login_Button.clicked.connect(userLogin(self.GuiUserName,self.GuiUserPassword))
...
#--------------------------------------Create New User Button----------------------------------------------------------#
        ...
        #self.CreateNewAccButton.clicked.connect(Register(self.GuiNewUserName, self.GuiNewUserPassword))
    ...
    def retranslateUi(self, MainWindow):
        ...
        getUserName = self.GuiUserName.text()
        self.Login_Button.clicked.connect(rint())
